    ...
    <div className="space-y-6 animate-fade-in text-slate-800 print:bg-white print:text-black">
      ...
      <div className="flex justify-between items-center border-b border-slate-200 pb-3 print:hidden">
        <div>
          ...
          <p className="text-[11px] text-slate-500 mt-0.5">Automated industrial reporting engine mapping all original workbook production indicators.</p>
        </div>
        <div className="flex space-x-2">
          <button 
            onClick={handleExportExcel}
            className="px-3.5 py-2 border border-slate-200 hover:bg-slate-50 text-xs font-bold rounded-xl transition-all cursor-pointer bg-white"
          >
            Export Excel
          </button>
          <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 bg-white border border-slate-200 p-4 rounded-2xl shadow-2xs print:hidden">
        ...
        <div className="space-y-1.5 col-span-1">
          <label className="text-[9px] uppercase font-bold text-slate-400 tracking-wider font-mono">Range</label>
          <select 
            value={dateRange}
        ...
        {/* Custom Start Date */}
        <div className="space-y-1.5 col-span-1">
          <label className="text-[9px] uppercase font-bold text-slate-400 tracking-wider font-mono">Start Date</label>
          <input 
            type="date" 
            value={startDate}
        ...
        {/* Custom End Date */}
        <div className="space-y-1.5 col-span-1">
          <label className="text-[9px] uppercase font-bold text-slate-400 tracking-wider font-mono">End Date</label>
          <input 
            type="date" 
            value={endDate}
        ...
        {/* View Mode Toggle */}
        <div className="space-y-1.5 col-span-1">
          <label className="text-[9px] uppercase font-bold text-slate-400 tracking-wider font-mono">Analysis View</label>
          <div className="grid grid-cols-2 gap-1 bg-slate-50 border border-slate-200 p-0.5 rounded-xl">
            <button 
              onClick={() => setViewMode('table')}
              className={`py-1.5 text-[11px] font-bold rounded-lg transition-all cursor-pointer ${viewMode === 'table' ? 'bg-white text-slate-900 shadow-2xs' : 'text-slate-500 hover:text-slate-800'}`}
            >
              Grid Table
            </button>
            <button 
              onClick={() => setViewMode('charts')}
              className={`py-1.5 text-[11px] font-bold rounded-lg transition-all cursor-pointer ${viewMode === 'charts' ? 'bg-white text-slate-900 shadow-2xs' : 'text-slate-500 hover:text-slate-800'}`}
            >
              SVG Chart
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        ...
        <div className="space-y-2 lg:col-span-1 print:hidden">
          ...
          <div className="space-y-1 bg-white border border-slate-200 p-2.5 rounded-2xl shadow-2xs">
            <button 
              onClick={() => setSelectedReportType('daily-production')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'daily-production' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Daily Production Sheet
            </button>
            <button 
              onClick={() => setSelectedReportType('monthly-executive')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'monthly-executive' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Monthly Executive Summary
            </button>
            <button 
              onClick={() => setSelectedReportType('party-customer')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'party-customer' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Party-Wise Customer Ledger
            </button>
            <button 
              onClick={() => setSelectedReportType('supplier-scrap')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'supplier-scrap' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Supplier Scrap Summary
            </button>
            <button 
              onClick={() => setSelectedReportType('size-wise-rebar')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'size-wise-rebar' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Size-Wise Rebar Report
            </button>
            <button 
              onClick={() => setSelectedReportType('billet-casting')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'billet-casting' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Billet Casting Heat Log
            </button>
            <button 
              onClick={() => setSelectedReportType('furnace-melting')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'furnace-melting' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Furnace Melting Log
            </button>
            <button 
              onClick={() => setSelectedReportType('billet-ccm-ledger')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'billet-ccm-ledger' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Billet CCM Casting Ledger
            </button>
            <button 
              onClick={() => setSelectedReportType('downtime-breakdown-tracker')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'downtime-breakdown-tracker' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Downtime & Breakdown Tracker
            </button>
            <button 
              onClick={() => setSelectedReportType('spectrometer-qa')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'spectrometer-qa' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              Spectrometer Chemistry & QA
            </button>
            <button 
              onClick={() => setSelectedReportType('plant-breakdown')}
              className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedReportType === 'plant-breakdown' ? 'bg-[#FAF6EE] text-[#B48F48]' : 'text-slate-500 hover:bg-slate-50'}`}
            >
