            ...
            <form onSubmit={handleFormSubmit} className="space-y-3.5">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="text-[9px] uppercase tracking-wider font-extrabold text-slate-450 ">Log Date</label>
                  <input 
                    type="date" 
                    value={form.date}
                ...
                <div className="space-y-1">
                  <label className="text-[9px] uppercase tracking-wider font-extrabold text-slate-450 ">Scrap Category</label>
                  <select 
              ...
              <div className="space-y-1">
                <label className="text-[9px] uppercase tracking-wider font-extrabold text-slate-450 ">Supplier Name</label>
                <input 
                  type="text" 
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="text-[9px] uppercase tracking-wider font-extrabold text-slate-450 ">Truck Number</label>
                  <input 
                    type="text" 
                    placeholder="TR-5022"
                    value={form.truck_no}
                ...
                <div className="space-y-1">
                  <label className="text-[9px] uppercase tracking-wider font-extrabold text-slate-450 ">Rate (৳/kg)</label>
                  <input 
                    type="number" 
                    placeholder="42"
