  ...
  const sidebarElement = (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="p-4 border-t border-slate-100 bg-slate-50/50 flex-shrink-0">
        <Link href="/tenant/garments/profile" onClick={() => setIsSidebarOpen(false)} className="flex flex-wrap items-center justify-between gap-4 mb-3.5 cursor-pointer hover:bg-slate-100/50 p-1 rounded-xl transition-all">
      ...
      <div className="flex-1 h-full flex flex-col overflow-hidden">
        <header className="h-14 border-b border-slate-200/60 bg-white/50 backdrop-blur-xs flex flex-wrap items-center justify-between gap-4 px-6 flex-shrink-0">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link href="/tenant/garments/profile" className="flex flex-wrap items-center gap-2 px-3.5 py-1.5 rounded-full border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 shadow-2xs">
