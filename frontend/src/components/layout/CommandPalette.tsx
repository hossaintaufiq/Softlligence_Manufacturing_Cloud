...
export function CommandPalette() {
  ...
  const allCommands: CommandItem[] = [
    ...
    { id: '5', title: 'Go to Executive Analytics & Reports', category: 'Navigation', path: '/analytics', shortcut: 'G A' },
    { id: '6', title: 'Go to IAM User & Roles', category: 'Navigation', path: '/iam' },
