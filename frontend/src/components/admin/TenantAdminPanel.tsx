      ...
      <div className="flex border-b border-slate-200 gap-4">
        <button
          ...
          className={`pb-2 text-xs font-bold border-b-2 transition-all ${
            activeTab === 'tenants' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-900'
          }`}
        >
          🔑 Tenants & Billing
        </button>
        <button
          ...
          className={`pb-2 text-xs font-bold border-b-2 transition-all ${
            activeTab === 'modules' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-900'
          }`}
        >
          🧩 System Modules
        </button>
        <button
          ...
          className={`pb-2 text-xs font-bold border-b-2 transition-all ${
            activeTab === 'health' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-900'
          }`}
        >
          ❤️ Platform Health
        </button>
